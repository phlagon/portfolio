                        ...
                        <div className="relative w-full">
                            ...
                            {rapidoScreen === 'offline' && (
                              <>
                                <button 
                                  ...
                                  className="absolute top-[72%] left-1/2 -translate-x-1/2 w-[60%] h-[5%] bg-transparent cursor-pointer z-[90]"
                            ...
                            {rapidoScreen === 'public-transport' && (
                              <button 
                                ...
                                className="absolute top-[28%] left-0 w-[80%] h-[10%] bg-transparent cursor-pointer z-[90]"
