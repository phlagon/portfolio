    ...
    <div className="fixed inset-0 bg-background flex flex-col items-center justify-center z-50">
      <div className="flex flex-col items-center gap-8">
        <video
          ...
          muted
          playsInline
          className="w-32 h-auto rounded-full shadow-[0_0_30px_hsl(var(--primary)/0.2)] grayscale"
        ...
        <div className="w-64 space-y-3">
           <Progress value={progress} className="h-0.5 bg-border/20" indicatorClassName="bg-primary shadow-[0_0_10px_hsl(var(--primary))]" />
